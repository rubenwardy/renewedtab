...
export const UA_DEFAULT = "Mozilla/5.0 (compatible; Renewed Tab App/1.8.1; +https://renewedtab.com/)";
export const UA_PROXY = "Mozilla/5.0 (compatible; Renewed Tab Proxy/1.8.1; +https://renewedtab.com/)";
